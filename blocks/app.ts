...
import BlocksController from './default/default.controller';
import { BlocksService } from './default/blocks.service';
...
async function main(event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
    ...
    try {
        const router = new Router(
            event,
            region,
            [{ controller: BlocksController, services: [BlocksService] }],
            '/blocks',
        );
